                        ...
                        <ul class="d-flex">
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn " href="{{url('cart')}}"
                                    ...
                                    <span class="header__account--btn__text"> My cart</span>
                                    @php
                                    $totalCartItems = totalCartItems(); // totalCartItems() function is in our custom Helpers/Helper.php file that we have registered in 'composer.json' file --}} 
                                @endphp
                                    <span class="items__count">{{$totalCartItems}}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
    ...
    <footer class="footer__section bg__black">
        <div class="container-fluid">
                ...
                <div class="footer__widget--menu__wrapper d-flex footer__widget--width">
                    <div class="footer__widget">
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                            ...
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text"
                                    href="{{url('user/login-register')}}">User Login/Register</a></li>
                ...
                <div class="footer__widget footer__widget--width">
                    ...
                    <div class="footer__widget--inner">
                        ...
                        <div class="newsletter__subscribe">
                            <form class="newsletter__subscribe--form" method="POST" action="{{url('add-subscriber-email')}}">
                                @csrf
                                <label>
                                    <input class="newsletter__subscribe--input" placeholder="Email Address" name="subscriber_email"
                                        type="email">
                                </label>
            ...
            <div class="footer__bottom d-flex justify-content-between align-items-center">
                <p class="copyright__content text-ofwhite m-0">Copyright © {{date('Y')}} <a class="copyright__content--link"
                        href="/">Suruchi</a> . All Rights Reserved Developed By Metro Web Technology</p>
                ...
                <div class="newsletter__popup--box__right">
                    ...
                    <div class="newsletter__popup--content">
                        ...
                        <div class="newsletter__popup--subscribe" id="frm_subscribe">
                            <form class="newsletter__popup--subscribe__form" method="POST" action="{{url('add-subscriber-email')}}">
                                @csrf
                                <input class="newsletter__popup--subscribe__input" type="text"
                                    placeholder="Enter you email address here..." name="subscriber_email">
